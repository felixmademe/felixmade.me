...
$(document).ready(function () {
  __webpack_require__(/*! ga-lite */ "./node_modules/ga-lite/dist/ga-lite.min.js");

  __webpack_require__(/*! cookieconsent */ "./node_modules/cookieconsent/build/cookieconsent.min.js");

  __webpack_require__(/*! lozad */ "./node_modules/lozad/dist/lozad.min.js");

  __webpack_require__(/*! ./modules/analytics */ "./resources/js/modules/analytics.js");

  __webpack_require__(/*! ./modules/consent */ "./resources/js/modules/consent.js");

  __webpack_require__(/*! ./modules/sw */ "./resources/js/modules/sw.js");
  ...
  __webpack_require__(/*! ./components/board */ "./resources/js/components/board.js");
});
...
function setsColour(message) {
  //console.log(message);
  var colours = ['#05C46B', '#F53B57', '#1E272E', '#FFF'];
  var colour, colourText, boxShadowColour, colourBorder, mes;
...
function setHoverEffect(message) {
  ...
  var boxShadow = message.style.boxShadow;
  var boxShadowColour = boxShadow.substr(0, 15);
...
function createMessage(data) {
  ...
  var time = $('<small class="time"></small>').text(data[1]);
  text.append(time);
  text.append('<br>');
...
/***/ "./resources/js/modules/consent.js":
/*!*****************************************!*\
  !*** ./resources/js/modules/consent.js ***!
  \*****************************************/
/*! no static exports found */
