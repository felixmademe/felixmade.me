...
@section( 'title', config( 'app.slogan' ) . '- Policy' )
...
@section( 'content' )
    <section class="policy">
        ...
        <hr>
        <h2>Use of Data</h2>
        <p><i>{{ config('app.name') }}</i> uses the collected data for various purposes:</p>
        <ul>
        ...
        <p><i>{{ config('app.name') }}</i> will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
        <hr>
        <h2>Disclosure Of Data</h2>
        <h3>Legal Requirements</h3>
        <p><i>{{ config('app.name') }}</i> may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of <i>{{ config('app.name') }}</i></li>
        ...
        <ul>
            <li>By email: <a href="mailto:{{ config('mail.from.address') }}">{{ config('mail.from.address') }}</a></li>
        </ul>
    </section>
@endsection
